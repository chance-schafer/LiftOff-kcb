...
<p align="center">
  <a href="https://github.com/Jan-23-Liftoff-KC/Team_ChatGPT_FrontEnd_Full">
    <img src="https://user-images.githubusercontent.com/98275292/208930594-7a5ceb37-8125-449d-83b3-02e7e64bb868.svg" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">KC Business Project</h3>

  <p align="center">
    Web App that helps you find minority owned businesses in the Kansas City area
    <br/>
    <br/>
    <a href="https://www.youtube.com/watch?v=ZHQ6mT0hFgY">View Demo</a>
    
  </p>
</p>

![Contributors](https://img.shields.io/github/contributors/Jan-23-Liftoff-KC/Team_ChatGPT_FrontEnd_Full?color=dark-green) 

## About The Project

Our project facilitates the discovery of minority-owned businesses in the Kansas City area. It allows users to search for these businesses based on location, type of the business, and the ethnicity or minority status of the owner (woman, latino, black, asian, LGBTQIA, Immigrant)

-As an user you can find these businesses. And if you create an account, you can also store them in a list for future reference. 

-As a business owner you can add, edit and delete your businesses information, as well as check other businesses in the area.


## Built With

Our technology stack consists of JavaScript, React, Redux, and React Bootstrap for the Front-End in order to create dynamic and responsive user interfaces. For the back-end, we use Java, Spring, Spring Security, and MySQL for our database needs. We also use Jest for testing. This stack provided us with the necessary tools and technologies to build a robust and reliable web application.
