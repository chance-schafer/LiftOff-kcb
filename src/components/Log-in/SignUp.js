...
export const SignUp = () => {
  ...
  return (
    <Container
      ...
      onKeyDown={showMessage}
      onKeyUp={showMessage}
    >
      {/* <svg id='svg-login' viewBox="0 0 994 889" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M991.305 761.192L117.095 845.262L72.6356 42.4584L928.661 2.60945L991.305 761.192Z" stroke="#AA283C" strokeWidth="5" strokeLinejoin="round" />
                <path d="M920.838 801.652L47.0722 885.762L2.63549 82.5747L858.225 42.707L920.838 801.652Z" stroke="#201D1D" strokeWidth="5" strokeLinejoin="round" />
            </svg> */}
      <Form id="log-in-form">
        ...
        <Form.Text>
          ...
          {!passwordError.hasSpclChr && (
            <div className="text-danger">
              At least one one of these characters: @ # $ % & !
            </div>
          )}
        </Form.Text>
